...
import {
  getActiveScreen,
  SignInUpScreens,
} from "../../../../passwordless/components/themes/signInUp";
        ...
        {(props.pwlessChildProps === undefined ||
          ...
          <React.Fragment>
            ...
            {props.commonState.error && (
              <GeneralError error={props.commonState.error} />
            )}
...
function SignInUpThemeWrapper(
  ...
  if (childProps.activeScreen === SignInUpScreens.CloseTab) {
    activeStyle =
      props.passwordlessRecipe!.config.signInUpFeature.closeTabScreenStyle;
  } else if (childProps.activeScreen === SignInUpScreens.LinkSent) {
    activeStyle =
      props.passwordlessRecipe!.config.signInUpFeature.linkSentScreenStyle;
  } else if (childProps.activeScreen === SignInUpScreens.UserInputCodeForm) {
    activeStyle =
      props.passwordlessRecipe!.config.signInUpFeature.userInputCodeFormStyle;
  } else {
...
function getCommonPwlessProps(
  ...
  return {
    ...
    clearError: () =>
      props.pwlessDispatch({ type: "setError", error: undefined }),
    onError: (error: string) =>
      props.pwlessDispatch({ type: "setError", error }),
